...
export default function AddPet(props) {
  ...
  const [
    textFieldThreeEightNineZeroFourFourTwoValue,
    setTextFieldThreeEightNineZeroFourFourTwoValue,
  ] = useState("");
  const [
    textFieldThreeEightNineZeroFourFiveSixValue,
    setTextFieldThreeEightNineZeroFourFiveSixValue,
  ] = useState("");
  const [
    textFieldThreeEightNineZeroFourFourNineValue,
    setTextFieldThreeEightNineZeroFourFourNineValue,
  ] = useState("");
    ...
    await client.graphql({
      ...
      variables: {
        input: {
          ...
          about: textFieldThreeEightNineZeroFourFourTwoValue,
          image: textFieldThreeEightNineZeroFourFiveSixValue,
          color: textFieldThreeEightNineZeroFourFourNineValue,
        },
      },
    });
  };
  const buttonThreeEightNineZeroFourEightFourOnClick = async () => {
    await client.graphql({
      ...
      >
        ...
        >
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeEightNineZeroFourFourTwoValue}
            onChange={(event) => {
              setTextFieldThreeEightNineZeroFourFourTwoValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField3890442")}
          ></TextField>
          <TextField
            width="unset"
            height="unset"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeEightNineZeroFourFourNineValue}
            onChange={(event) => {
              setTextFieldThreeEightNineZeroFourFourNineValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField3890449")}
          ></TextField>
          <TextField
            width="unset"
            height="unset"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeEightNineZeroFourFiveSixValue}
            onChange={(event) => {
              setTextFieldThreeEightNineZeroFourFiveSixValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField3890456")}
          ></TextField>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          ...
          <Button
            ...
            children="Update"
            onClick={() => {
              buttonThreeEightNineZeroFourEightFourOnClick();
            }}
            {...getOverrideProps(overrides, "Button3890484")}
          ></Button>
        </Flex>
      </Flex>
    </Flex>
